# Mazare3 — Privacy Policy Phase 3C.4B.2B Review Export

**Status:** DRAFT only — NOT counsel-activated — NOT Production-active  
**Document type:** privacy_policy  
**Version:** 1.1.1-advisor-revised  
**Preserved history:** 1.1.0-advisor-revised, 1.0.1-launch-candidate  
...
- formal DPO appointment / publishable DPO contact (`dpoAppointed=false`; candidate internal-only: INTERNAL_DPO_CANDIDATE)
...
- Article 14 transfer consent ready only after processors + disclosures finalised (SUFFICIENT_ONCE_PROCESSORS_AND_DISCLOSURE_FINALISED)
...
```json
{
  ...
  "productionBlocker": "PROCESSOR_IDENTITY_UNRESOLVED — do not mark Article 14 transfer consent ready until active processor legal names/contacts and recipient disclosures are confirmed",
  "googleMinimalPreConsentLegalBasis": "LEGAL_BASIS_COUNSEL_REVIEW_REQUIRED",
  "note": "Prefer linking privacyNoticeVersionId at Prior Consent grant when Article 14 disclosure lives in the Privacy Policy version. Optional metadata may record recipientDisclosureLinkedToPrivacyNotice=true. No new large consent model."
}
```
...
تواصل الخصوصية: [[PRIVACY_CONTACT_EMAIL]]. وإلى أن يُضبط تواصل خصوصية قابل للنشر، يمكن للأشخاص المعنيين استخدام أدوات الخصوصية داخل الحساب حيث تتوفر.

تواصل مراقب حماية البيانات الشخصية: [[DPO_OR_PRIVACY_CONTACT]].


## 3. فئات البيانات الشخصية — العملاء
...
| [[PAYMENT_PROVIDER_LEGAL_NAME]] | معالجة البطاقة ونتائج الدفع | بيانات دفع وصفية؛ بيانات البطاقة لدى المزود (لا تخزّن مزارع الرقم الكامل/رمز الأمان) | [[PAYMENT_PROVIDER_PRIVACY_CONTACT]] | وفق تهيئة المزود |
| [[GOOGLE_SIGNIN_PROVIDER_LEGAL_NAME]] (عند استخدام تسجيل الدخول عبر Google) | مصادقة الحساب | معرّف حساب Google والاسم والبريد الإلكتروني كما تُستلم لتسجيل الدخول / إنشاء الحساب أو ربطه | [[GOOGLE_SIGNIN_PROVIDER_PRIVACY_CONTACT]] | وفق تشغيل المزود |
| [[ACTIVE_EMAIL_PROVIDER_LEGAL_NAME]] (عند تفعيل البريد التشغيلي) | إشعارات تشغيلية | عنوان البريد ومحتوى الرسالة اللازم للإشعارات | [[ACTIVE_EMAIL_PROVIDER_PRIVACY_CONTACT]] | وفق التهيئة عند التفعيل |
...
وقد يعالج بعض المعالجين أو مزودي الخدمات البيانات الشخصية أو يخزّنونها خارج الأردن. وتُذكر مناطق المزودين النشطين في هذه السياسة كما يلي: [[PROCESSOR_REGION_NEON]]، [[PROCESSOR_REGION_R2]]، [[APP_HOSTING_PROVIDER]]، [[APP_HOSTING_REGION]].
...
## 18. خرق أمن وسلامة البيانات الشخصية
...
تصدر سياسة الخصوصية هذه بإصدارات. الإصدار: 1.1.1-advisor-revised. تاريخ السريان: [[PRIVACY_POLICY_EFFECTIVE_DATE]]. آخر تحديث: [[PRIVACY_POLICY_LAST_UPDATED_DATE]].
...
## B. FULL English Privacy Policy (1.1.1-advisor-revised)

```markdown
# Privacy Policy

This Privacy Policy explains how Personal Data is processed in connection with the Mazare3 marketplace (Mazare3 / Mazare3 Jordan / مزارع الأردن), operated by [[LEGAL_ENTITY_INTRO_EN]]. This document is a transparency notice. Acknowledging this Privacy Policy is not Prior Consent, and is separate from accepting the Terms & Conditions and from any optional marketing or analytics choices. Version: 1.1.1-advisor-revised. Effective date: [[PRIVACY_POLICY_EFFECTIVE_DATE]]. Last updated: [[PRIVACY_POLICY_LAST_UPDATED_DATE]].
...
Privacy contact: [[PRIVACY_CONTACT_EMAIL]]. Until a publishable privacy contact is configured, Data Subjects may use in-account privacy tools where available.
...
| [[PAYMENT_PROVIDER_LEGAL_NAME]] | Card processing and payment outcomes | Payment metadata; card data handled by the provider (Mazare3 does not store PAN/CVV) | [[PAYMENT_PROVIDER_PRIVACY_CONTACT]] | As configured with the provider |
| [[GOOGLE_SIGNIN_PROVIDER_LEGAL_NAME]] (when Google sign-in is used) | Account authentication | Google account identifier, name, and email as received for sign-in / account creation or linking | [[GOOGLE_SIGNIN_PROVIDER_PRIVACY_CONTACT]] | As operated by the provider |
| [[ACTIVE_EMAIL_PROVIDER_LEGAL_NAME]] (when transactional email is enabled) | Operational notices | Email address and message content needed for notices | [[ACTIVE_EMAIL_PROVIDER_PRIVACY_CONTACT]] | As configured when enabled |
...
Some processors or service providers may process or store Personal Data outside Jordan. Provider regions for active processors are stated in this Policy as: [[PROCESSOR_REGION_NEON]], [[PROCESSOR_REGION_R2]], [[APP_HOSTING_PROVIDER]], [[APP_HOSTING_REGION]].
...
## 16. Complaints and regulatory note
...
## 18. Compromise of the security and integrity of Personal Data
...
This Privacy Policy is versioned. Version: 1.1.1-advisor-revised. Effective date: [[PRIVACY_POLICY_EFFECTIVE_DATE]]. Last updated: [[PRIVACY_POLICY_LAST_UPDATED_DATE]].
