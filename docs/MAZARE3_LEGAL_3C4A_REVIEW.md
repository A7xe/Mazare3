# Mazare3 Legal Corpus — Phase 3C.4A Advisor-Revised Review Export

Read-only export of the three customer legal documents revised in Phase 3C.4A.

- **Version:** `1.1.0-advisor-revised`
- **Status:** DRAFT
- **Interpolation:** NONE — placeholders preserved as in source.
- **Out of scope:** Privacy, Owner Agreement, Verification, Community, Cookie.

---

# 1. Terms & Conditions

- **Exact document name (EN):** Terms & Conditions
- **Exact document name (AR):** الشروط والأحكام
- **Repository source path:** `packages/shared/src/legal-content/terms-and-conditions.ts`
- **Document type code:** `terms_and_conditions`
- **Version:** `1.1.0-advisor-revised`
...
تحكم هذه الشروط والأحكام الوصول إلى سوق مزارع واستخدامه (مزارع / مزارع الأردن) الذي تشغّله [[LEGAL_ENTITY_INTRO_AR]].

## 1. المقدمة

تحكم هذه الشروط والأحكام («الشروط») وصولك إلى سوق مزارع واستخدامك له (اسم المنتج: مزارع / مزارع الأردن)، وتشغّله [[LEGAL_ENTITY_INTRO_AR]].

تُدمج في هذه الشروط بالإحالة سياسة الخصوصية، وسياسة الإلغاء والاسترداد، وشروط الحجز المعروضة عند إتمام الدفع، وسياسة التحقق، وسياسة المجتمع والمراجعات، وسياسة ملفات تعريف الارتباط، كلٌّ بحسب انطباقه على استخدامك.
...
- «العربون» الدفعة الجزئية عند تطبيق خطة عربون 30٪.
- «الرصيد المتبقي» المبلغ المتبقي بعد العربون.
- «المبلغ المحصّل» المال الذي جُمع بنجاح للحجز.
- «المبلغ المسترد» المال الذي أُعيد بنجاح إلى العميل، أو سُجّل لإعادته، وفق مسار الاسترداد المعمول به.
- «صافي المبلغ المحصّل» المبلغ المحصّل ناقص المبالغ المستردة المكتملة أو المنعكسة حيث يقتضي السياق رقماً صافياً.
...
- «العمولة» أجر منصة مزارع. النسبة القياسية 18٪. وتكون النسبة 15٪ عندما يكون الإعلان «تم التحقق بواسطة Mazare3»، ما لم تُطبَّق شروط تجارية مخصّصة سارية بين مزارع والمالك.
...
مزارع ليست مالكاً أو مشغّلاً يومياً للعقارات المعروضة، وليست مؤمِّناً، وليست خدمة ضمان، وليست جهة تحقق حكومية، وليست وكالة سفر ما لم يُنص على خلاف ذلك صراحةً وكتابةً.

خدمة الضيافة/المكان للحجز يقدّمها المالك. تسهّل مزارع علاقة السوق والخدمات المنصّية الموضحة في هذه الشروط.


## 7. العلاقة مع مالكي العقارات
...
عمولة المنصة القياسية 18٪. وعندما يكون الإعلان «تم التحقق بواسطة Mazare3» (مراجعة منصة مزارع — وليست شهادة حكومية)، تكون نسبة العمولة 15٪، ما لم تُطبَّق شروط تجارية مخصّصة سارية.
...
لا تخترع مزارع قواعد ضريبية في هذه الشروط. أي ضرائب أو فواتير تخضع للقانون المعمول به والتزامات كل طرف.


## 10. تكوين الحجز

يُنشأ الحجز عندما تسجّل مزارع بنجاح طلب حجز لفترة متاحة تحت حساب العميل. تعتمد حالة التأكيد على نجاح الدفع، وعند الاقتضاء، موافقة المالك.
...
## 11. موافقة المالك والحجز الفوري
...
## 13. العربون والرصيد المتبقي

يعتمد التوقيت على بداية فترة الحجز الفعلية بتوقيت Asia/Amman.

إذا بدأت فترة الحجز بعد أكثر من 72 ساعة، يجوز للعميل اختيار عربون 30٪ أو الدفع الكامل. وإذا كانت البداية خلال 72 ساعة أو أقل، يُطلب الدفع بنسبة 100٪.

لحجوزات العربون، يُستحق الرصيد المتبقي قبل 48 ساعة من البداية الفعلية على الأكثر. إذا بقي الرصيد المتبقي غير مدفوع عند ذلك الموعد، فسيُلغى الحجز تلقائياً، مع مراعاة مطابقة حالة الدفع اللازمة لتجنّب إلغاء دفعة اكتملت بنجاح. ويُحتفظ بالمبلغ المحصّل من العربون، ولا تُجمع مبالغ إلغاء إضافية فوق الأموال المحصّلة، وتُحرَّر الفترة.


## 14. إلغاء العميل

يتبع إلغاء العميل لحجز مؤكد مدفوع قبل البداية سياسة الإلغاء والاسترداد. يعتمد التوقيت على بداية فترة الحجز الفعلية بتوقيت Asia/Amman. والرسوم نسب مئوية من قيمة الحجز المعتمدة لأغراض الإلغاء. والمبلغ المحتفظ به هو الأقل بين المبلغ المحصّل المتاح للاحتفاظ ورسوم السياسة المنطبقة. ولا تجمع مزارع مالاً غير محصّل لمجرد استيفاء نسبة إلغاء.

- أكثر من 72 ساعة قبل البداية: رسوم إلغاء 0٪ (استرداد كامل للمبلغ المحصّل، مع مراعاة أي استردادات مكتملة مسبقاً).
- أكثر من 48 ساعة وحتى 72 ساعة قبل البداية: رسوم إلغاء 30٪.
- أكثر من 24 ساعة وحتى 48 ساعة قبل البداية: رسوم إلغاء 50٪.
- 24 ساعة أو أقل قبل البداية: رسوم إلغاء 100٪.
- بعد بداية الحجز: الإلغاء العادي قبل الوصول غير متاح؛ تُطبَّق إجراءات عدم الحضور أو الحوادث أو النزاعات حسب الحالة.


## 15. إلغاء المالك

إذا تسبب المالك في إلغاء حجز مؤكد، يسترد العميل 100٪ من المبالغ المحصّلة لذلك الحجز، ويكون صرف المالك لذلك الحجز صفراً.

قد تنطبق أيضاً غرامات مالية على المالك وعواقب متعلقة بالموثوقية. وتفاصيل تلك الغرامات ترد أساساً في اتفاق المالك وسياسة الإلغاء والاسترداد (بما في ذلك شرائح التوقيت مثل أكثر من 72 ساعة، وبين 24 و72 ساعة بنسبة 10٪، و24 ساعة أو أقل بنسبة 20٪، مع تقييد المبالغ عادة بين 10 و50 د.أ كتعديلات تسوية — وليست خصوماً تلقائية من البطاقة). القوة القاهرة الحقيقية: لا غرامة على المالك.


## 16. عدم الحضور

عدم حضور العميل ليس تلقائياً لمجرد غياب تسجيل الوصول. قد يُعتمد فقط بعد بداية الحجز مضافاً إليها فترة سماح 60 دقيقة، عند استيفاء شروط الدفع وعدم تحقق تسجيل الوصول وعدم وجود حالة غير محسومة منسوبة لخطأ المالك أو منع الوصول أو القوة القاهرة. يجوز للمالك الإبلاغ؛ ويُشترط تأكيد الإدارة. عند التأكيد: استرداد العميل = 0؛ ويتلقى المالك أرباحه المستحقة العادية؛ وتتلقى مزارع عمولتها المنطبقة العادية.

عدم حضور المالك المؤكد أو منع الوصول غير المبرر: يسترد العميل 100٪ من المبالغ المحصّلة؛ صرف المالك = 0؛ وقد تنطبق غرامة المالك وعواقب الموثوقية كما في اتفاق المالك وسياسة الإلغاء والاسترداد؛ ولا تحتفظ مزارع بالعمولة العادية على قيمة الحجز المستردة في تلك الحالة.


## 17. تسجيل الوصول

قد توفر مزارع رمزاً لمرة واحدة لتسجيل الوصول كدليل وصول أو تسليم. يتاح عادة قبل 2 ساعة من البداية وينتهي بعد 120 دقيقة من البداية (وفق قواعد المنتج).
...
لا يجوز لأي طرف تغيير حجز مؤكد من طرف واحد. إعادة الجدولة بطلب العميل تتطلب قبول المالك وتُحدَّ عادة بـ 1 إعادة جدولة ناجحة بطلب العميل لكل حجز. قد تنتهي نوافذ رد الطرف الآخر (مثلاً 48 ساعة وفق قواعد المنتج).

بمبادرة العميل: نفس السعر → بلا تعديل؛ أعلى → يدفع العميل الفرق المقبول قبل الإتمام؛ أدنى → يُسترد الفرق المستحق. بمبادرة المالك: لا يمكن إجبار العميل على دفع مبلغ أعلى لمجرد طلب النقل؛ ويُستوعب السعر الأعلى البديل وفق قواعد النظام؛ والسعر الأرخص قد ينشئ استرداداً مستحقاً.

لا يجوز استخدام إعادة الجدولة لإعادة ضبط ساعة الإلغاء بطريقة تُضعِف حماية إلغاء العميل بعد تغيير بطلب العميل. استثناءات القوة القاهرة أو الإدارة تتبع إعفاءات النظام.
...
النتائج المحتملة: إعادة جدولة مجانية أو مكافئة، أو استرداد كامل عندما يتعذّر المضي في الحجز بشكل معقول. غرامة المالك = 0 للقوة القاهرة الحقيقية. لا تعد مزارع بتعويض نقدي خارجي يتجاوز الاسترداد أو إعادة الجدولة المعمول بهما.


## 20. الاستردادات

لا يؤدي الإلغاء إلى جمع مزارع مالاً لم يكن مبلغاً محصّلاً أصلاً لمجرد استيفاء نسبة إلغاء. المبلغ المحتفظ به هو الأقل بين المبلغ المحصّل المتاح للاحتفاظ ورسوم السياسة المنطبقة. والمبلغ القابل للاسترداد هو ما يتبقى من المبلغ المحصّل بعد ذلك الاحتفاظ (عند الإيجاب)، مع مراعاة أي مبالغ مستردة مكتملة مسبقاً.

تُعالَج الاستردادات المستحقة عبر مسار استرداد موثّق وقابل للتتبع لدى مزارع من خلال مزود خدمة الدفع الذي تُهيّئه. قد يعتمد ظهور المبلغ في البنك أو البطاقة على ذلك المزود ومصدر البطاقة. لا تعد مزارع بموعد وصول ثابت غير مدعوم للأموال المستردة.

تتبع الاستردادات سياسة الإلغاء والاسترداد. ولا تنص هذه الشروط على أن كل مبلغ محصّل نهائي بلا مسار استرداد.


## 21. الوصول إلى العقار
...
## 22. سلوك العميل وعدالة منع الوصول
...
## 27. الاستخدام المحظور والاحتيالي
...
علامات مزارع والبرمجيات ومحتوى المنصة مملوكة لـ [[LEGAL_ENTITY_NAME]] أو مرخّصيها. يمنح المالكون مزارع ترخيصاً لاستضافة وعرض محتوى الإعلان الذي يرفعونه لتشغيل السوق. يجب على المستخدمين عدم نسخ مواد المنصة إلا بما يسمح به القانون أو إذن كتابي.


## 32. خدمات الأطراف الثالثة ومزودو الدفع
...
لا يستبعد أو يحدّ أي بند في هذه الشروط مسؤولية لا يجوز استبعادها أو تقييدها بموجب القانون الأردني الإلزامي، بما في ذلك مسؤولية مزارع عن احتيالها أو أي مسؤولية أخرى لا يجوز قانوناً استبعادها. وتبقى الحقوق الإلزامية للمستهلك محفوظة.


## 35. حفظ الحقوق النظامية للمستهلك
...
## 38. المراسلات والسجلات الإلكترونية
...
## 40. تسوية النزاعات والاختصاص

ينبغي للطرفين أولاً محاولة التسوية بحسن نية عبر دعم مزارع. مع مراعاة القانون الإلزامي، يجوز عرض النزاعات على المحاكم الأردنية المختصة.
...
المشغّل: [[LEGAL_ENTITY_NAME]]. السجل التجاري: [[COMMERCIAL_REGISTRATION_NUMBER]]. العنوان المسجّل: [[REGISTERED_ADDRESS]]. التواصل القانوني: [[LEGAL_CONTACT_EMAIL]].
...
These Terms & Conditions govern access to and use of the Mazare3 marketplace (Mazare3 / Mazare3 Jordan) operated by [[LEGAL_ENTITY_INTRO_EN]].

## 1. Introduction

These Terms & Conditions ("Terms") govern your access to and use of the Mazare3 marketplace (product name: Mazare3 / Mazare3 Jordan) operated by [[LEGAL_ENTITY_INTRO_EN]].

These Terms incorporate by reference the Privacy Policy, Cancellation & Refund Policy, Booking Terms presented at checkout, Verification Policy, Community & Review Policy, and Cookie Policy, each as applicable to your use.
...
- “Deposit” means the partial payment when a 30% deposit plan applies.
- “Balance” means the remaining amount due after a Deposit.
- “Captured Amount” means money successfully collected for a Booking.
- “Refunded Amount” means money successfully returned, or recorded for return, to the Customer under the applicable refund process.
- “Net Collected Amount” means the Captured Amount minus completed or reflected Refunded Amounts where context requires a net figure.
...
- “Commission” means Mazare3’s platform fee. The standard rate is 18%. The rate is 15% when the listing is Verified by Mazare3, unless valid custom commercial terms between Mazare3 and the Owner apply.
...
## 7. Relationship with property Owners

Owners are independent parties. Commercial terms between Mazare3 and an Owner (commission, settlement, verification) are governed by the Owner Agreement and any accepted partner commercial terms.
...
Standard platform commission is 18%. When a listing is Verified by Mazare3 (Mazare3 platform review — not government certification), the commission rate is 15%, unless valid custom commercial terms apply.
...
Mazare3 does not invent tax rules in these Terms. Any taxes or invoices follow applicable law and the parties’ respective obligations.


## 10. Booking formation
...
## 11. Owner approval and instant booking
...
## 13. Deposit and Balance

Timing uses the actual booking period start in Asia/Amman.

If the Booking starts in more than 72 hours, the Customer may choose a 30% Deposit or full payment. If the Booking starts in 72 hours or less, 100% payment is required.

For Deposit bookings, the Balance is due no later than 48 hours before actual start. If the Balance remains unpaid at that deadline, the Booking will be automatically cancelled, subject to payment-status reconciliation needed to avoid cancelling a payment that has already completed successfully. The Captured Amount of the Deposit is retained, no additional cancellation money is collected beyond captured funds, and the slot is released.


## 14. Customer cancellation

Customer cancellation of a confirmed paid Booking before start follows the Cancellation & Refund Policy. Timing uses actual booking period start in Asia/Amman. Charges are percentages of the Booking Value for Cancellation Purposes. The amount retained is the lesser of the Captured Amount available for retention and the applicable policy charge. Mazare3 does not collect uncaptured money merely to satisfy a cancellation percentage.

- More than 72 hours before start: 0% cancellation charge (full refund of the Captured Amount, subject to any already completed refunds).
- More than 48 hours and up to 72 hours before start: 30% cancellation charge.
- More than 24 hours and up to 48 hours before start: 50% cancellation charge.
- 24 hours or less before start: 100% cancellation charge.
...
## 15. Owner cancellation

If an Owner causes cancellation of a confirmed Booking, the Customer receives a 100% refund of Captured Amounts for that Booking, and Owner payout for that Booking is zero.

Owner financial penalties and reliability consequences may also apply. Those penalty details live mainly in the Owner Agreement and the Cancellation & Refund Policy (including timing tiers such as more than 72 hours, between 24 and 72 hours at 10%, and 24 hours or less at 20%, with amounts typically clamped between 10 JOD and 50 JOD as settlement adjustments — not automatic card charges). Genuine force majeure: no Owner penalty.


## 16. No-show

Customer no-show is not automatic merely because check-in is missing. It may be finalised only after booking start plus a 60-minute grace period, when payment conditions are met, check-in was not verified, and no unresolved Owner-fault, access-denied, or force-majeure condition applies. Owners may report; admin confirmation is required. Confirmed Customer no-show: Customer refund = 0; the Owner receives normal eligible earnings; Mazare3 receives its normal applicable commission.

Confirmed Owner no-show or unjustified denied access: Customer receives a 100% refund of Captured Amounts; Owner payout = 0; Owner penalty and reliability consequences may apply as set out in the Owner Agreement and Cancellation & Refund Policy; Mazare3 does not retain ordinary commission on the refunded booking value in that case.


## 17. Check-in

Mazare3 may provide a one-time check-in code as arrival or handover evidence. It typically becomes available 2 hours before start and expires 120 minutes after start (product rules).
...
Neither party may unilaterally change a confirmed Booking. Customer-requested reschedule requires Owner acceptance and is normally limited to 1 successful customer-requested reschedule per Booking. Counterparty response windows may expire (for example 48 hours under product rules).

Customer-initiated: same price → no adjustment; higher → Customer pays the accepted difference before finalisation; lower → eligible difference refunded. Owner-initiated: the Customer cannot be forced to pay a higher price merely because the Owner requested the move; a higher replacement list price is absorbed per system rules; a cheaper replacement may create an eligible refund.

Rescheduling must not reset the cancellation clock in a way that softens Customer cancellation protection after a customer-requested change. Force-majeure or admin exceptions follow system exemptions.
...
Possible outcomes: free or equivalent reschedule, or full refund where the Booking cannot reasonably proceed. Owner penalty = 0 for genuine force majeure. Mazare3 does not promise external cash compensation beyond applicable refunds or reschedules.


## 20. Refunds

Cancellation never causes Mazare3 to collect money that was not already a Captured Amount merely to satisfy a cancellation percentage. The retained amount is the lesser of the Captured Amount available for retention and the applicable policy charge. The refundable amount is what remains of the Captured Amount after that retention (when positive), accounting for any already completed Refunded Amounts.

Eligible refunds are processed through Mazare3’s tracked refund process via Mazare3’s configured payment service provider. Actual bank or card posting time may depend on that provider and the card issuer. Mazare3 does not promise an unsupported fixed arrival date for refunded funds.
...
## 22. Customer conduct and access-denied fairness
...
## 27. Prohibited and fraudulent use
...
## 30. Platform service availability
...
Mazare3 branding, software, and platform content are owned by [[LEGAL_ENTITY_NAME]] or its licensors. Owners grant Mazare3 a licence to host and display listing content they upload for marketplace operation. Users must not copy platform materials except as allowed by law or written permission.


## 32. Third-party services and payment providers
...
Nothing in these Terms excludes or limits liability that cannot be excluded or limited under Jordanian mandatory law, including liability for Mazare3’s own fraud or other liability that legally cannot be excluded. Mandatory consumer rights remain preserved.


## 35. Consumer statutory rights preserved
...
## 37. Changes to Terms and versioning
...
## 40. Dispute and forum provision

Parties should first attempt good-faith resolution via Mazare3 support. Subject to mandatory law, disputes may be submitted to the competent courts of Jordan.
...
Operator: [[LEGAL_ENTITY_NAME]]. Commercial registration: [[COMMERCIAL_REGISTRATION_NUMBER]]. Registered address: [[REGISTERED_ADDRESS]]. Legal contact: [[LEGAL_CONTACT_EMAIL]].
...
- **Exact document name (EN):** Cancellation & Refund Policy
- **Exact document name (AR):** سياسة الإلغاء والاسترداد
- **Repository source path:** `packages/shared/src/legal-content/cancellation-refund-policy.ts`
- **Document type code:** `cancellation_refund_policy`
- **Version:** `1.1.0-advisor-revised`
...
توضح هذه السياسة كيف يعمل الإلغاء والاسترداد على مزارع للعملاء. يعتمد التوقيت على بداية الحجز الفعلية بتوقيت Asia/Amman. وتعمل مع الشروط والأحكام وشروط الحجز.
...
- «المبلغ المحصّل» المال الذي جُمع بنجاح للحجز.
- «المبلغ المسترد» المال الذي أُعيد بنجاح، أو سُجّل لإعادته، إلى العميل وفق مسار الاسترداد المعمول به.
- «صافي المحصّل» المبلغ المحصّل ناقص الاستردادات المكتملة أو المنعكسة، حيث يلزم ذلك الرقم الصافي.
- «رسوم الإلغاء» قيمة الحجز المعتمدة لأغراض الإلغاء × النسبة المعمول بها في البند 4.
- «المبلغ المحتفظ به» الأقل بين (أ) المبلغ المحصّل المتاح للاحتفاظ و(ب) رسوم الإلغاء.
- «الاسترداد» المبلغ المحصّل المتاح للاسترداد بعد تطبيق المبلغ المحتفظ به.
...
## 4. العربون والرصيد المتبقي

يعتمد التوقيت على بداية الحجز الفعلية بتوقيت Asia/Amman.

إذا بدأت فترة الحجز بعد أكثر من 72 ساعة، يجوز للعميل اختيار عربون بنسبة 30٪ أو الدفع الكامل. وإذا كانت البداية خلال 72 ساعة أو أقل، يُطلب الدفع الكامل.

لحجوزات العربون المؤهلة، يستحق الرصيد المتبقي قبل 48 ساعة من البداية الفعلية على الأكثر. إذا بقي الرصيد غير مدفوع عند حلول ذلك الموعد، يُلغى الحجز تلقائياً وفق قواعد الدفع في مزارع، بعد مطابقة حالة الدفع حتى لا يُلغى دفع رصيد اكتمل بنجاح بالخطأ. يُحتفظ بالعربون المحصّل؛ ولا يُجمع مبلغ إلغاء إضافي؛ وتُحرَّر الفترة.


## 5. شرائح إلغاء العميل
...
- | --- | --- |
- | أكثر من 72 ساعة | 0٪ |
- | أكثر من 48 ساعة وحتى 72 ساعة | 30٪ |
- | أكثر من 24 ساعة وحتى 48 ساعة | 50٪ |
- | 24 ساعة أو أقل قبل البداية | 100٪ |
- | بعد بداية الحجز | الإلغاء العادي غير متاح؛ تُطبَّق قواعد الحوادث / عدم الحضور / النزاعات |


## 6. كيف يُحسب الاسترداد
...
الخطوة 3 — الاسترداد: المبلغ المحصّل المتاح للاسترداد بعد تطبيق المبلغ المحتفظ به.

لن تُحصّل مزارع مبالغ متبقية غير مدفوعة لمجرد أن نسبة الإلغاء تطابق شريحة معلنة.


## 7. أمثلة (حجز بقيمة 200 د.أ)

افترض أن قيمة الحجز المعتمدة لأغراض الإلغاء = 200 د.أ.

إذا طُبّق عربون بنسبة 30٪، فالعربون = 60 د.أ والرصيد المتبقي = 140 د.أ.

- مدفوع بالكامل 200 د.أ، إلغاء بعد أكثر من 72 ساعة قبل البداية: الرسوم 0؛ المحتفظ به 0؛ الاسترداد 200 د.أ.
- مدفوع بالكامل 200 د.أ، إلغاء في نافذة أكثر من 48 ساعة وحتى 72 ساعة: الرسوم 60 د.أ؛ المحتفظ به 60؛ الاسترداد 140 د.أ.
- مدفوع بالكامل 200 د.أ، إلغاء في نافذة أكثر من 24 ساعة وحتى 48 ساعة: الرسوم 100 د.أ؛ المحتفظ به 100؛ الاسترداد 100 د.أ.
- مدفوع بالكامل 200 د.أ، إلغاء خلال 24 ساعة أو أقل قبل البداية: الرسوم 200 د.أ؛ المحتفظ به 200؛ الاسترداد 0.
- عربون محصّل فقط (60 د.أ)، إلغاء في نافذة أكثر من 48 ساعة وحتى 72 ساعة: رسوم السياسة = 60 د.أ؛ المحتفظ به = 60 د.أ؛ الاسترداد = 0. لا تجمع مزارع الـ 140 د.أ غير المدفوعة لمجرد أن النسبة 30٪.
- عربون محصّل فقط (60 د.أ)، إلغاء بعد أكثر من 72 ساعة قبل البداية: المحتفظ به 0؛ الاسترداد 60 د.أ.


## 8. الإلغاء بسبب المالك

إذا تسبب المالك بإلغاء حجز مؤكد: يسترد العميل 100٪ من مدفوعات الحجز المحصّلة؛ ويكون صرف المالك لذلك الحجز صفراً؛ وقد تُطبَّق غرامات داخلية وعواقب موثوقية بموجب اتفاق المالك وقواعد عدالة مزارع.

القوة القاهرة المعتمدة بعد المراجعة: يُطبَّق استرداد للعميل أو إعادة جدولة مكافئة مؤهلة؛ ولا تُطبَّق غرامة على المالك.


## 9. عدم الحضور ومنع الوصول

عدم حضور العميل ليس تلقائياً لمجرد غياب تسجيل الوصول. لا يُعتمد إلا بعد بداية الحجز، وبعد فترة سماح 60 دقيقة، وعند استيفاء شروط الدفع وعدم تحقق تسجيل الوصول وعدم وجود حالة مفتوحة منسوبة لخطأ المالك / منع الوصول / القوة القاهرة، ويجوز للمالك الإبلاغ، ويُشترط تأكيد الإدارة. عند التأكيد: استرداد العميل = 0.

عدم حضور المالك المؤكد أو منع الوصول غير المبرر (بعد المراجعة): يسترد العميل 100٪ من المحصّل؛ صرف المالك = 0؛ وقد تُطبَّق غرامة ضمن الحدود (بما فيها حد أدنى 10 د.أ وحد أقصى 50 د.أ حيث تكون الشريحة 10٪ أو 20٪).
...
## 10. إعادة الجدولة والقوة القاهرة

إعادة الجدولة تتطلب اتفاقاً وفق قواعد المنتج (عادة حتى 1 إعادة جدولة ناجحة بطلب العميل لكل حجز). ولا يجوز أن تُضعف عمليات النقل بطلب العميل حماية الإلغاء بإعادة ضبط الساعات بشكل غير عادل.

بمبادرة العميل: نفس السعر → بلا تعديل؛ أعلى → يدفع العميل الفرق المقبول قبل الإتمام؛ أدنى → يُسترد الفرق المستحق. بمبادرة المالك: لا يُجبر العميل على دفع سعر بديل أعلى لمجرد أن المالك طلب التغيير؛ والسعر الأرخص قد ينشئ استرداداً مستحقاً.

عند حدث قوة قاهرة حقيقي يجعل المضي في الحجز متعذّراً موضوعياً، يجوز لمزارع تطبيق إعادة جدولة مكافئة مؤهلة أو استرداد كامل بعد المراجعة.


## 11. كيف تُعالَج الاستردادات

تمر الاستردادات المستحقة عبر مسار استرداد موثّق وقابل للتتبع مع مزود خدمة الدفع. قد تبقى الحالة معلّقة حتى يؤكد المزود. يعتمد ظهور المبلغ في البنك أو البطاقة على المزود ومصدر البطاقة. لا تعد مزارع بيوم وصول محدد للأموال المستردة.


## 12. التواصل

للاستفسار: [[LEGAL_CONTACT_EMAIL]]. المشغّل: [[LEGAL_ENTITY_NAME]]. لمسائل الحجز استخدم «حجوزاتي» والدعم داخل المنتج.

## English

# Cancellation & Refund Policy

This Policy explains how cancellations and refunds work on Mazare3 for Customers. Timing uses the actual Booking start in Asia/Amman. It works together with the Terms & Conditions and Booking Terms.
...
- “Refunded Amount” means money successfully returned, or recorded for return, to the Customer under the applicable refund process.
- “Net Collected Amount” means Captured Amount minus completed or reflected refunds, where that net figure is needed.
- “Cancellation charge” means Booking Value for Cancellation Purposes × the applicable percentage in section 4.
- “Retained amount” means the lesser of (a) the Captured Amount available for retention and (b) the cancellation charge.
- “Refund” means the Captured Amount available for refund after the retained amount is applied.


## 3. Before payment is captured
...
Timing uses the actual Booking start in Asia/Amman.

If the Booking starts in more than 72 hours, the Customer may choose a 30% Deposit or pay in full. If the Booking starts in 72 hours or less, full payment is required.

For eligible Deposit Bookings, the remaining Balance is due no later than 48 hours before actual start. If the Balance remains unpaid when that deadline has passed, the Booking will be automatically cancelled under Mazare3’s payment rules, after payment-status reconciliation so a successfully completed Balance payment is not cancelled by mistake. The captured Deposit is retained; no additional cancellation amount is collected; the slot is released.


## 5. Customer cancellation tiers
...
- | More than 48 hours and up to 72 hours | 30% |
- | More than 24 hours and up to 48 hours | 50% |
- | 24 hours or less before start | 100% |
- | After Booking start | Ordinary cancellation is unavailable; incident / no-show / dispute rules apply |


## 6. How the refund is calculated
...
Step 3 — Refund: Captured Amount available for refund after the retained amount is applied.

Mazare3 will not charge unpaid remaining amounts merely because a cancellation percentage equals a stated tier.


## 7. Examples (200 JOD Booking)

Assume Booking Value for Cancellation Purposes = 200 JOD.

If a 30% Deposit applies, Deposit = 60 JOD and remaining Balance = 140 JOD.

- Fully paid 200 JOD, cancel more than 72 hours before start: charge 0 JOD; retained 0; refund 200 JOD.
- Fully paid 200 JOD, cancel in the window of more than 48 hours and up to 72 hours: charge 60 JOD; retained 60; refund 140 JOD.
- Fully paid 200 JOD, cancel in the window of more than 24 hours and up to 48 hours: charge 100 JOD; retained 100; refund 100 JOD.
- Fully paid 200 JOD, cancel 24 hours or less before start: charge 200 JOD; retained 200; refund 0.
- Deposit only captured (60 JOD), cancel in the window of more than 48 hours and up to 72 hours: policy charge = 60 JOD; retained = 60 JOD; refund = 0. Mazare3 does not collect the unpaid 140 JOD merely because the percentage is 30%.
- Deposit only captured (60 JOD), cancel more than 72 hours before start: retained 0; refund 60 JOD.


## 8. Owner-caused cancellation

If an Owner causes cancellation of a confirmed Booking: the Customer receives a 100% refund of captured Booking payments; Owner payout for that Booking is zero; internal Owner penalties and reliability consequences may apply under the Owner Agreement and Mazare3 fairness rules.

Force majeure treated as genuine after review: Customer refund or eligible equivalent reschedule applies; Owner penalty does not apply.


## 9. No-shows and access denied

Customer no-show is not automatic merely because check-in is missing. It may be finalised only after Booking start, after a 60-minute grace period, when payment conditions are satisfied, check-in is not verified, no unresolved Owner-fault / access-denied / force-majeure condition applies, the Owner may report, and admin confirmation is required. Confirmed Customer no-show: Customer refund = 0.

Confirmed Owner no-show or unjustified access denied (after review): Customer receives 100% refund of captured payments; Owner payout = 0; Owner penalty may apply within policy limits (including minimum 10 JOD and maximum 50 JOD where the applicable tier is 10% or 20%).
...
## 10. Rescheduling and force majeure

Rescheduling requires agreement under product rules (normally up to 1 successful Customer-requested reschedule per Booking). Customer-requested moves must not weaken cancellation protection by resetting clocks unfairly.

Customer-initiated: same price → no adjustment; higher → Customer pays the accepted difference before completion; lower → eligible difference refunded. Owner-initiated: the Customer cannot be forced to pay a higher replacement price solely because the Owner requested the change; a cheaper replacement may generate an eligible refund.

Where a genuine force-majeure event makes the Booking objectively unable to proceed, Mazare3 may apply an eligible equivalent reschedule or full refund after review.


## 11. How refunds are processed

Eligible refunds follow Mazare3’s tracked refund process with the payment service provider. Status may remain pending until the provider confirms. Bank or card posting time depends on the provider and the card issuer. Mazare3 does not promise an exact arrival day for refunded funds.


## 12. Contact

Questions: [[LEGAL_CONTACT_EMAIL]]. Operator: [[LEGAL_ENTITY_NAME]]. For Booking issues, use My bookings and in-product support.

---

# 3. Booking Terms

- **Exact document name (EN):** Booking Terms
- **Exact document name (AR):** شروط الحجز
- **Repository source path:** `packages/shared/src/legal-content/booking-terms.ts`
- **Document type code:** `booking_terms`
- **Version:** `1.1.0-advisor-revised`
...
تلخّص شروط الحجز هذه ما تؤكده عند إتمام الدفع على مزارع. وهي لا تحل محل الشروط والأحكام الكاملة أو سياسة الإلغاء والاسترداد.

## 1. ما تؤكده عند إتمام الدفع
...
يُظهر إتمام الدفع المبلغ المستحق فوراً (عربون أو دفع كامل) وأي رصيد متبقٍ. يعتمد التوقيت على بداية الحجز الفعلية بتوقيت Asia/Amman.

إذا بقي أكثر من 72 ساعة على البداية، يجوز اختيار عربون بنسبة 30٪ أو الدفع الكامل. وخلال 72 ساعة من البداية يُطلب الدفع الكامل.

أي رصيد متبقٍ يستحق قبل 48 ساعة من البداية على الأكثر. إذا بقي غير مدفوع عند حلول الموعد، يُلغى الحجز تلقائياً وفق قواعد الدفع بعد مطابقة حالة الدفع؛ ويُحتفظ بالعربون المحصّل؛ ولا يُجمع مبلغ إلغاء إضافي.
...
إذا تسبب المالك بإلغاء حجز مؤكد، تسترد 100٪ من مدفوعات الحجز المحصّلة. صرف المالك لذلك الحجز يكون صفراً. تفاصيل غرامات المالك في سياسة الإلغاء والاسترداد واتفاق المالك.


## 6. قواعد العقار وتسجيل الوصول وعدم الحضور
...
عدم حضور العميل ليس تلقائياً. يتطلب بداية الحجز، وفترة سماح 60 دقيقة، واستيفاء شروط الدفع، وعدم تحقق تسجيل الوصول، وغياب حالة مفتوحة لخطأ المالك / منع الوصول / القوة القاهرة، وقد يبلّغ المالك، ويُشترط تأكيد الإدارة.

يتاح تسجيل الوصول عادة قبل 2 ساعة من البداية وينتهي بعد 120 دقيقة من البداية وفق قواعد المنتج.


## 7. إعادة الجدولة

إعادة الجدولة تحتاج اتفاقاً وفق قواعد المنتج (عادة حتى 1 تغيير ناجح بطلب العميل). بمبادرة العميل: نفس السعر → بلا تعديل؛ أعلى → تدفع الفرق المقبول قبل الإتمام؛ أدنى → يُسترد الفرق المستحق. بمبادرة المالك: لا تُجبر على دفع سعر بديل أعلى لمجرد أن المالك طلب التغيير.


## 8. القوة القاهرة

عند حدث قوة قاهرة حقيقي يجعل المضي في الحجز متعذّراً موضوعياً، يجوز لمزارع تطبيق إعادة جدولة مكافئة مؤهلة أو استرداد كامل بعد المراجعة وفق السياسة المعمول بها.


## 9. أي المستندات تحكم ماذا

تحكم الشروط والأحكام وشروط الحجز هذه وسياسة الإلغاء والاسترداد القواعد التعاقدية والاقتصادية للحجز (السعر والعربون والرصيد المتبقي والإلغاء والاسترداد وعدم الحضور وإعادة الجدولة).

توضح سياسة الخصوصية كيف تُعالَج البيانات الشخصية. وما زلت تُقرّ بسياسة الخصوصية عبر مسار الخصوصية المعمول به. وهي ليست شرطاً اقتصادياً يحدد السعر أو نسب الاسترداد.

مزارع سوق وليست مؤمِّناً وليست خدمة ضمان. المشغّل: [[LEGAL_ENTITY_NAME]].

## English

# Booking Terms

These Booking Terms summarise what you confirm at checkout on Mazare3. They do not replace the full Terms & Conditions or the Cancellation & Refund Policy.

## 1. What you confirm at checkout
...
Checkout shows the amount due now (Deposit or full payment) and any future Balance. Timing uses the actual Booking start in Asia/Amman.

If start is more than 72 hours away, you may choose a 30% Deposit or pay in full. Within 72 hours of start, full payment is required.

Any remaining Balance is due no later than 48 hours before start. If unpaid when that deadline has passed, the Booking will be automatically cancelled under Mazare3’s payment rules after payment-status reconciliation; the captured Deposit is retained; no additional cancellation amount is collected.
...
- More than 72 hours before start: 0%.
- More than 48 hours and up to 72 hours: 30%.
- More than 24 hours and up to 48 hours: 50%.
- 24 hours or less before start: 100%.
...
## 5. If the Owner cancels

If an Owner causes cancellation of a confirmed Booking, you receive a 100% refund of captured Booking payments. Owner payout for that Booking is zero. Detailed Owner penalty rules are in the Cancellation & Refund Policy and Owner Agreement.


## 6. Property rules, check-in, and no-show
...
Customer no-show is not automatic. It requires Booking start, a 60-minute grace period, satisfied payment conditions, unverified check-in, no unresolved Owner-fault / access-denied / force-majeure condition, possible Owner report, and admin confirmation.

Check-in typically becomes available 2 hours before start and expires 120 minutes after start under product rules.


## 7. Rescheduling

Rescheduling needs agreement under product rules (normally up to 1 successful Customer-requested change). Customer-initiated: same price → no adjustment; higher → you pay the accepted difference before completion; lower → eligible difference refunded. Owner-initiated: you cannot be forced to pay a higher replacement price solely because the Owner requested the change.


## 8. Force majeure

Where a genuine force-majeure event makes the Booking objectively unable to proceed, Mazare3 may apply an eligible equivalent reschedule or full refund after review under the applicable policy.


## 9. Which documents govern what

The Terms & Conditions, these Booking Terms, and the Cancellation & Refund Policy govern Booking contractual and economic rules (price, Deposit, Balance, cancellation, refunds, no-show, reschedule).

The Privacy Policy explains how Personal Data is processed. You still acknowledge the Privacy Policy through the applicable privacy flow. It is not an economic term that sets price or refund percentages.

Mazare3 is a marketplace, not an insurer and not an escrow service. Operator: [[LEGAL_ENTITY_NAME]].

---

# Export metadata

- Exported from `getLaunchLegalDocument` markdown fields (no placeholder fill).
- Source legal files were not modified by this export step.
