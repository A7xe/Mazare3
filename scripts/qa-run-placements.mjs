/**
 * Focused 10F.3A runner: placements + search ranking/discovery regression.
 */
...
const SCRIPTS = ['qa-placements-api.mjs', 'qa-search-api.mjs', 'qa-search-math.mjs'];
...
async function main() {
  ...
  try {
    ...
    console.log('\n✅ Focused placement + search regression tests passed\n');
  } catch (e) {
