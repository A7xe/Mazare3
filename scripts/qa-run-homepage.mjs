/**
 * Focused 10F.4A runner: homepage discovery + placement + search regression.
 */
...
const QA_PORT = process.env.QA_API_PORT ?? '4030';
const QA_BASE = `http://localhost:${QA_PORT}/api/v1`;
const USE_SHELL = process.platform === 'win32';

const SCRIPTS = ['qa-homepage-discovery-api.mjs', 'qa-placements-api.mjs', 'qa-search-api.mjs'];
...
async function main() {
  ...
  try {
    ...
    console.log('\n✅ Focused homepage discovery + placement + search tests passed\n');
  } catch (e) {
