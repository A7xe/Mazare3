/**
 * Focused 10G.1 runner: gateway boundary + deposit/payment + coupon finance + integrity.
 */
...
const QA_PORT = process.env.QA_API_PORT ?? '4034';
...
async function main() {
  ...
  try {
    ...
    console.log('\n✅ Focused payment gateway boundary + regressions passed\n');
  } catch (e) {
