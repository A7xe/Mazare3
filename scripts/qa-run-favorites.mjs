/**
 * Focused 10E.2 runner: favorites + search math.
 */
...
const QA_PORT = process.env.QA_API_PORT ?? '4020';
const QA_BASE = `http://localhost:${QA_PORT}/api/v1`;
const USE_SHELL = process.platform === 'win32';

const SCRIPTS = ['qa-favorites-api.mjs', 'qa-search-math.mjs'];
...
async function main() {
  ...
  try {
    ...
    console.log('\n✅ Focused favorites + search-math tests passed\n');
  } catch (e) {
