/**
 * Run PayTabs reconciliation QA + payment integrity against a mock API.
 * Does not create live PayTabs transactions.
 */
...
const QA_PORT = process.env.QA_API_PORT ?? '4039';
...
async function main() {
  ...
  try {
    ...
    await runScript('qa-paytabs-reconciliation-probe.mjs');
  } finally {
    killServer();
  }
}
