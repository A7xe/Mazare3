/**
 * Focused 10F.4B runner: home personalization + rebooking + favorites + homepage discovery.
 */
...
const QA_PORT = process.env.QA_API_PORT ?? '4032';
const QA_BASE = `http://localhost:${QA_PORT}/api/v1`;
const USE_SHELL = process.platform === 'win32';

const SCRIPTS = [
  'qa-home-personalization-api.mjs',
  'qa-rebooking-api.mjs',
  'qa-favorites-api.mjs',
  'qa-homepage-discovery-api.mjs',
];
...
async function main() {
  ...
  try {
    ...
    console.log('\n✅ Focused home personalization + regressions passed\n');
  } catch (e) {
