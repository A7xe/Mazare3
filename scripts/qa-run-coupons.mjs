/**
 * Focused 10F.2A runner: coupons + promotion pricing + deposit math.
 */
...
const QA_PORT = process.env.QA_API_PORT ?? '4024';
const QA_BASE = `http://localhost:${QA_PORT}/api/v1`;
const USE_SHELL = process.platform === 'win32';

const SCRIPTS = ['qa-coupons-api.mjs', 'qa-platform-coupons-api.mjs', 'qa-promotions-api.mjs', 'qa-deposit-math.mjs'];
...
async function main() {
  ...
  try {
    ...
    console.log('\n✅ Focused coupon + promotion + deposit-math tests passed\n');
  } catch (e) {
