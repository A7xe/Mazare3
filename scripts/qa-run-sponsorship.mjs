/**
 * Focused 10F.3B runner: sponsorship orders + placement regression + settlement integrity.
 */
...
const SCRIPTS = ['qa-sponsorship-api.mjs', 'qa-placements-api.mjs', 'qa-settlement-cycle-api.mjs'];
...
async function main() {
  ...
  try {
    ...
    console.log('\n✅ Focused sponsorship + placement + settlement integrity tests passed\n');
  } catch (e) {
