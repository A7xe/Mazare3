/**
 * Focused runner: Phase 3C.4A.1 balance-deadline API QA against a local QA API.
 */
...
const QA_PORT = process.env.QA_API_PORT ?? '4027';
...
async function main() {
  ...
  try {
    ...
    console.log('\n── qa-phase3c4a1-balance-deadline-api.mjs ──\n');
    await runNode('scripts/qa-phase3c4a1-balance-deadline-api.mjs', {
      API_BASE: QA_BASE,
      ENABLE_INTERNAL_QA_ROUTES: 'true',
    });
    console.log('\n✅ Phase 3C.4A.1 balance-deadline API QA passed\n');
  } catch (e) {
